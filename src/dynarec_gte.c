/*
 * dynarec_gte.c - GTE (COP2) instruction emitter
 *
 * Contains all GTE inline helper emitters and the COP2 instruction
 * dispatcher emit_gte_instruction().  Split from dynarec_insn.c for
 * maintainability.
 */
#include "dynarec.h"
#undef LOG_TAG
...
/* ================================================================
 * emit_gte_instruction - COP2 (GTE) opcode dispatcher
 * ================================================================
 * Called from emit_instruction() after the CU2 check.  Handles
 * MFC2/MTC2/CFC2/CTC2 data transfers and GTE command execution.
 */
